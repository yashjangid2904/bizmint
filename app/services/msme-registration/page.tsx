...
const MSMERegistrationPage = () => {
  const highlights = [
    { title: "Udyam Registration", desc: "The new statutory registration process for micro, small, and medium enterprises.", icon: Building, color: "text-blue-600" },
    { title: "Collateral Free Loans", desc: "Priority access to credit and CGTMSE benefits from various financial institutions.", icon: Percent, color: "text-emerald-500" },
    { title: "Government Tenders", desc: "Exclusive benefits and exemptions in government procurement and tender processes.", icon: Briefcase, color: "text-purple-600" },
    { title: "Interest Subvention", desc: "Eligibility for lower interest rates and subsidies on business loans.", icon: Zap, color: "text-indigo-600" },
  ];

  const process = [
    { name: "Self Declaration", desc: "Providing details of investment in plant/machinery and annual turnover." },
    { name: "Aadhaar Integration", desc: "Verification of the entrepreneur's identity through Aadhaar OTP." },
    { name: "Online Submission", desc: "Filing the digital application on the official Udyam portal." },
    { name: "Certificate", desc: "Instant generation of the lifetime valid Udyam Registration Certificate." },
  ];
      ...
      <section className="relative pt-32 pb-20">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Empower your small business. MSME registration unlocks a world of 
              subsidies, priority credit, and government protection for your enterprise.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col gap-16 lg:flex-row">
            <div className="lg:w-1/3">
              <h2 className="font-outfit text-4xl font-bold text-zinc-900 dark:text-white">MSME Benefits</h2>
              <p className="mt-6 text-zinc-600 dark:text-zinc-400">
                Beyond registration, we help you understand and claim the various state 
                and central government benefits your business is entitled to.
              </p>
              <div className="mt-10 flex items-center gap-4 p-6 rounded-2xl bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20">
                ...
                <div>
                  <div className="font-bold text-zinc-900 dark:text-white">Payment Protection</div>
                  <div className="text-sm text-blue-600">MSME Samadhaan Support</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-[3rem] bg-zinc-900 p-12 text-center dark:bg-blue-600">
            <h2 className="font-outfit text-4xl font-bold text-white">Unlock MSME Benefits Today</h2>
            <p className="mt-6 text-zinc-400 dark:text-blue-100 max-w-xl mx-auto">
              Get your Udyam registration certificate in under 24 hours and start 
              availing government subsidies and loan benefits.
            </p>
            <Link
              href="/contact?service=msme-registration"
